...
from .functional import t5_rms_norm_forward, nn_layer_norm_forward, nn_linear_forward, llama_mlp_forward, gelu_forward
...
def apply_patch_to_mllama_text_model(
    ...
    for layer in base_model.layers:
        layer: Union[MllamaCrossAttentionDecoderLayer, MllamaSelfAttentionDecoderLayer]
        if norm:
