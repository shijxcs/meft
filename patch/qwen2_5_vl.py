...
from .functional import t5_rms_norm_forward, nn_layer_norm_forward, nn_linear_forward, llama_mlp_forward
...
def apply_patch_to_qwen2_5_vl_text_model(
    ...
    from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VLTextModel, Qwen2_5_VLDecoderLayer, Qwen2_5_VLAttention, Qwen2_5_VLFlashAttention2, Qwen2_5_VLSdpaAttention
    base_model: Qwen2_5_VLTextModel = model.base_model

    for layer in base_model.layers:
        layer: Qwen2_5_VLDecoderLayer
        self_attn: Union[Qwen2_5_VLAttention, Qwen2_5_VLFlashAttention2, Qwen2_5_VLSdpaAttention] = layer.self_attn
        if norm:
...
def apply_patch_to_qwen2_5_vl_vision_model(
    ...
    from transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VisionTransformerPretrainedModel, Qwen2_5_VLVisionBlock, Qwen2_5_VLVisionAttention, Qwen2_5_VLVisionFlashAttention2, Qwen2_5_VLVisionSdpaAttention
    ...
    for layer in base_model.blocks:
        ...
        attn: Union[Qwen2_5_VLVisionAttention, Qwen2_5_VLVisionFlashAttention2, Qwen2_5_VLVisionSdpaAttention] = layer.attn
        if norm:
