...
def apply_patch_to_gemma_model(
    model: "transformers.models.gemma.modeling_gemma.GemmaPreTrainedModel",
    norm: bool = False,
    attn_in: bool = False,
    attn_out: bool = False,
    mlp_in: bool = False,
    ...
    from transformers.models.gemma.modeling_gemma import GemmaModel, GemmaDecoderLayer
    base_model: GemmaModel = model.base_model
