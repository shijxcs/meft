...
def apply_patch_to_gemma2_model(
    model: "transformers.models.gemma2.modeling_gemma2.Gemma2PreTrainedModel",
    norm: bool = False,
    attn_in: bool = False,
    attn_out: bool = False,
    mlp_in: bool = False,
    ...
    from transformers.models.gemma2.modeling_gemma2 import Gemma2Model, Gemma2DecoderLayer
    base_model: Gemma2Model = model.base_model
