...
from ..functions import nn_layer_norm_forward, nn_linear_forward, gelu_pytorch_tanh_forward
from ..patch import _checkpoint_module, _patch_module


def apply_patch_to_siglip_model(
    model: "transformers.models.siglip.modeling_siglip.SiglipPreTrainedModel",
    norm: bool = False,
    attn_in: bool = False,
    attn_out: bool = False,
    mlp_in: bool = False,
    ...
    base_model: SiglipModel = model.base_model

    apply_patch_to_siglip_text_model(
...
def apply_patch_to_siglip_text_model(
    model: "transformers.models.siglip.modeling_siglip.SiglipPreTrainedModel",
    norm: bool = False,
    attn_in: bool = False,
    attn_out: bool = False,
    ...
    from transformers.models.siglip.modeling_siglip import SiglipTextModel, SiglipEncoderLayer
    base_model: SiglipTextModel = model.base_model
...
def apply_patch_to_siglip_vision_model(
    model: "transformers.models.siglip.modeling_siglip.SiglipPreTrainedModel",
    norm: bool = False,
    attn_in: bool = False,
    attn_out: bool = False,
    ...
    base_model: SiglipVisionModel = model.base_model
