...
def apply_patch_to_granite_model(
    model: "transformers.models.granite.modeling_granite.GranitePreTrainedModel",
    norm: bool = False,
    attn_in: bool = False,
    attn_out: bool = False,
    mlp_in: bool = False,
    ...
    from transformers.models.granite.modeling_granite import GraniteModel, GraniteDecoderLayer
    base_model: GraniteModel = model.base_model

    for layer in base_model.layers:
        layer: GraniteDecoderLayer
        if norm:
